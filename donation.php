...
<div id="myContainer">
<h1>Пожертвування</h1>
<p>Якщо Ви хочете підтримати tapinambur API та зробити пожертвування, будь ласка, натисніть на кнопку “Donate” нижче. Вітається будь-яка сума пожертвування. Усі кошти підуть на покращення роботи tapinambur API, що допоможе наповнювати Ваші сайт ще якіснішим та цікавішим контентом.</p>
